...
class Metareports {
  ...
  function custom_post_type() {
    ...
    $labels = array(
      'name'                  => _x( 'Meta Reports', 'Post Type General Name', 'text_domain' ),
      'singular_name'         => _x( 'Meta Report', 'Post Type Singular Name', 'text_domain' ),
    ...
    $args = array(
      ...
      'taxonomies'            => array('metareport_categories'),
      'hierarchical'          => false,
      'public'                => true,
      'show_ui'               => true,
      'show_in_menu'          => true,
    ...
    register_post_type( 'metareports', $args );
  }
