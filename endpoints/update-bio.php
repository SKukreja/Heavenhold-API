...
function heroes_update_bio($request) {
    ...
    update_field('bio_fields_height', $height, $revision_id);
    update_field('bio_fields_weight', $weight, $revision_id);
    update_field('bio_fields_age', $age, $revision_id);    
    update_field('bio_fields_species', $species, $revision_id);
    update_field('bio_fields_role', $role, $revision_id);
    update_field('bio_fields_element', $element, $revision_id);
